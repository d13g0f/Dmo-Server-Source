...
namespace DigitalWorldOnline.Commons.Entities
{
    ...
    public class GameClient
    {
        ...
        public int ServerExperienceType { get; private set; }
        ...
        public void RemovePremium(int premium)
        {
        ...
        public void SetServerExperienceType(int experienceType) => ServerExperienceType = experienceType;
