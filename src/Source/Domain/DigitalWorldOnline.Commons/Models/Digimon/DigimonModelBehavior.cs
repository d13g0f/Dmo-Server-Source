...
namespace DigitalWorldOnline.Commons.Models.Digimon
{
    public sealed partial class DigimonModel
    {
        ...
        /// </summary>
        /// 
        public void StartConsistentAutoAttack() => AutoAttack = true;
        ...
        /// Set attack end time.
        /// </summary>
        public void SetEndAttacking(int value = 10) => EndAttacking = DateTime.Now.AddMilliseconds(AS);

        /// <summary>
        /// Set skill cast end time.
        /// </summary>
        /// <param name="time">Timestamp for the skill end</param>
        public void SetEndCasting(int time) => EndCasting = DateTime.Now.AddMilliseconds(10 + time);
