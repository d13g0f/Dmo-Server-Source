...
namespace DigitalWorldOnline.GameHost
{
    public sealed partial class MapServer
    {
       ...
       public async Task SafeWarp(GameClient client, short fallbackMapId, int fallbackX, int fallbackY)
        ...
        public void AddSummonMobs(short mapId, SummonMobModel summon, int channel)
        {
        ...
        public async Task CallDiscord(string message, GameClient tamer, string coloured, string local, string Channel = "1378115841811415181", bool custom = false)
        {
            var myChannel = 1378115841811415181;
            var myToken = "MTM2ODM4NjU0MTY5NjU4MTc1Mg.GQtBmX.664fWvwsy2eUBU8vBnV1l6f8v7mpi11gmNvDiM";
            ...
            using (var client = new HttpClient())
            {
                var request = new HttpRequestMessage
                {
                    ...
                    RequestUri = new Uri($"https://discordapp.com/api/v10/channels/{1378115841811415181}/messages"),
