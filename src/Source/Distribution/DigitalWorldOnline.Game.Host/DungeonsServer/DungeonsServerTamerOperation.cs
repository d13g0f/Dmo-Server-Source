        ...
        public void TamerOperation(GameMap map)
        {
            ...
            foreach (var tamer in map.ConnectedTamers)
            {
                ...
                if (tamer.CheckBuffsTime)
                {
                    ...
                    {
                        var buffsToRemove = tamer.Partner.BuffList.Buffs.Where(x => x.Expired).ToList();
                ...
                if (tamer.SaveResourcesTime)
                {
                    ...
                    {
                        _logger.Information($"Save resources elapsed time: {subStopWatch.ElapsedMilliseconds}");
                    }
                }
