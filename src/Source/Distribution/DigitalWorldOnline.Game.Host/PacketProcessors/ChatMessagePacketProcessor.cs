                ...
                case AccountAccessLevelEnum.Vip3:
                    {
                        if (message.StartsWith("!"))
                        {
                            ...
                            await _sender.Send(new CreateCommandMessageCommand(CommandMessageModel.Create(client.TamerId, client.Tamer.Name, message)));
                        }
                        else
                        {
                ...
                case AccountAccessLevelEnum.Administrator:
                    {
                        if (message.StartsWith("!"))
                        {
                            ...
                            await _sender.Send(new CreateCommandMessageCommand(CommandMessageModel.Create(client.TamerId, message, client.Tamer.Name)));
                        }
                        else
                        {
                            switch (mapConfig?.Type)
