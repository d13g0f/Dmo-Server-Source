        ...
        public async Task Process(GameClient client, byte[] packetData)
        {
            ...
            if (PersonalShop != null)
            {
                ...
                if (client.Tamer.Inventory.Bits < totalValue)
                {
                    ...
                    //var banMessage = banProcessor.BanAccountWithMessage(client.AccountId, client.Tamer.Name, AccountBlockEnum.Permanent, "Cheating", client, "You tried to buy an item with an invalid amount of bits using a cheat method, So be happy with ban!");
