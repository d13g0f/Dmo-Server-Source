    ...
    public class QuestDeliverPacketProcessor : IGamePacketProcessor
    {
        ...
        public async Task Process(GameClient client, byte[] packetData)
        {
            ...
            try
            {
                ...
                if (questInfo == null)
                {
                    _logger.Error($"[QuestDeliver] :: Tamer {client.Tamer.Name} tryed to deliver QuestId {questId} not on database !!");
                ...
                //_logger.Information($"Character {client.TamerId} delivered quest {questId}.");
            ...
            {
                _logger.Error($"[QuestDeliverPacketProcessor] :: {ex.Message}");
            }
        }
