        ...
        public async Task Process(GameClient client, byte[] packetData)
        {
            ...
            foreach (var item in sellList)
            {
                ...
                if (item.Amount > HasQuanty)
                {
                    ...
                    //var banMessage = banProcessor.BanAccountWithMessage(client.AccountId, client.Tamer.Name, AccountBlockEnum.Permanent, "Cheating", client, "You tried to open a shop invalid amount of item using a cheat method, So be happy with ban!");
