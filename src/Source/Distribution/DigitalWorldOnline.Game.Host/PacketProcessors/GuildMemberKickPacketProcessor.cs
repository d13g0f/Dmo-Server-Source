...
namespace DigitalWorldOnline.Game.PacketProcessors
{
    public class GuildMemberKickPacketProcessor : IGamePacketProcessor
    {
        ...
        public async Task Process(GameClient client, byte[] packetData)
        {
            ...
            var targetMember = targetGuild.FindMember(targetCharacter.TamerId);
            ...
            foreach (var guildMember in targetGuild.Members)
            {
                ...
                _mapServer.BroadcastForUniqueTamer(guildMember.CharacterId,
                    new GuildMemberKickPacket(targetCharacter.Tamer.Name).Serialize());
            ...
            targetGuild.RemoveMember(targetCharacter.TamerId);
            ...
            _logger.Debug($"Removing member {targetCharacter.TamerId} for guild {targetGuild.Id}...");
            await _sender.Send(new DeleteGuildMemberCommand(targetCharacter.TamerId, targetGuild.Id));
        }
    }
}