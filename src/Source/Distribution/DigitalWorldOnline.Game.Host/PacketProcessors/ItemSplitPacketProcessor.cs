                ...
                case ItemListMovimentationEnum.InventoryToInventory:
                    {
                        ...
                        if (sourceItem.Amount < amountToSplit)
                        {
                            ...
                            //var banMessage = banProcessor.BanAccountWithMessage(client.AccountId, client.Tamer.Name, AccountBlockEnum.Short, "Cheating", client, "You tried to split an invalid amount of item using a cheat method, So be happy with ban!");
