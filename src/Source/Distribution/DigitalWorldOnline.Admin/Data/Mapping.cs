...
public class AdminMappingProfile :Profile
{
    public AdminMappingProfile()
    {
        ...
        CreateMap<MobConfigDTO,MobUpdateViewModel>().ReverseMap();

        // Events
        CreateMap<EventViewModel,EventConfigDTO>().ReverseMap();
        CreateMap<EventMapViewModel,EventMapsConfigDTO>().ReverseMap();
        CreateMap<EventBitsDropConfigModel,EventBitsDropConfigDTO>().ReverseMap();
        CreateMap<EventItemDropConfigModel,EventItemDropConfigDTO>().ReverseMap();
        CreateMap<EventMobConfigModel,EventMobConfigDTO>().ReverseMap();
        ...
        CreateMap<SummonMobItemDropDTO,SummonMobItemDropViewModel>().ReverseMap();
