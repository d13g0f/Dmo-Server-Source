    ...
    public partial class FixDeckBuff : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.Sql(@"
                IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name = 'IX_Tamer_DeckBuffId' AND object_id = OBJECT_ID('Character.Tamer'))
                BEGIN
                    CREATE INDEX IX_Tamer_DeckBuffId ON Character.Tamer (DeckBuffId);
                END;
            ");
