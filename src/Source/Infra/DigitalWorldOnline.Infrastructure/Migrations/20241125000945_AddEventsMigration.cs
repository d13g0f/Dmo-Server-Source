    ...
    public partial class AddEventsMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.Sql(@"
                IF NOT EXISTS (SELECT 1 FROM sys.key_constraints WHERE name = 'AK_Map_MapId' AND parent_object_id = OBJECT_ID('Config.Map'))
                BEGIN
                    ALTER TABLE Config.Map ADD CONSTRAINT AK_Map_MapId UNIQUE (MapId);
                END;
            ");
