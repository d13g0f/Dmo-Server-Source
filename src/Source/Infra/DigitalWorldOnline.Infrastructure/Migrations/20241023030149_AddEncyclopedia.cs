...
{
    /// <inheritdoc />
    public partial class AddEncyclopedia : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.Sql(@"
                IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name = 'AK_DigimonBaseInfo_Type' AND object_id = OBJECT_ID('Asset.DigimonBaseInfo'))
                BEGIN
                    ALTER TABLE Asset.DigimonBaseInfo
                    ADD CONSTRAINT AK_DigimonBaseInfo_Type UNIQUE (Type);
                END;
            ");
