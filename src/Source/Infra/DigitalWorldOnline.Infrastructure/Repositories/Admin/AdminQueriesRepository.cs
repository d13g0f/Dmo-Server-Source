...
namespace DigitalWorldOnline.Infrastructure.Repositories.Admin
{
    public class AdminQueriesRepository : IAdminQueriesRepository
    {
        ...
        public async Task<GetSummonMobsQueryDto> GetSummonMobsAsync(long mapId, int limit, int offset, string sortColumn, SortDirectionEnum sortDirection, string? filter)
        {
        ...
        public async Task<GetEventMapsQueryDto> GetEventMapsAsync(long eventId, int limit, int offset, string sortColumn, SortDirectionEnum sortDirection, string? filter)
        {
        ...
        public async Task<GetEventMapMobsQueryDto> GetEventMapMobsAsync(long mapId, int limit, int offset, string sortColumn, SortDirectionEnum sortDirection, string? filter)
        {
        ...
        public async Task<GetEventMapRaidsQueryDto> GetEventMapRaidsAsync(long mapId, int limit, int offset, string sortColumn, SortDirectionEnum sortDirection, string? filter)
        {
        ...
        public async Task<GetEventRaidsQueryDto> GetEventRaidsAsync(long mapId, int limit, int offset, string sortColumn, SortDirectionEnum sortDirection, string? filter)
        {
