...
namespace DigitalWorldOnline.Infrastructure.Mapping
{
    public class AdminProfile : Profile
    {
        public AdminProfile()
        {
            ...
            CreateMap<AccountBlockDTO, AccountBlockViewModel>().ReverseMap();
            ...
            CreateMap<EventMobConfigDTO, MobViewModel>().ReverseMap();

            CreateMap<EventMobLocationConfigDTO, MobLocationViewModel>().ReverseMap();

            CreateMap<EventMobExpRewardConfigDTO, MobExpRewardViewModel>().ReverseMap();

            CreateMap<EventMobDropRewardConfigDTO, MobDropRewardViewModel>().ReverseMap();

            CreateMap<EventItemDropConfigDTO, MobItemDropViewModel>().ReverseMap();

            CreateMap<EventBitsDropConfigDTO, MobBitDropViewModel>().ReverseMap();

            CreateMap<MapRegionAssetDTO, SpawnPointViewModel>().ReverseMap();

            CreateMap<MapRegionAssetDTO, SpawnPointCreationViewModel>().ReverseMap();

            CreateMap<MapRegionAssetDTO, SpawnPointUpdateViewModel>().ReverseMap();

            CreateMap<ScanDetailAssetDTO, ScanDetailViewModel>().ReverseMap();

            CreateMap<ScanRewardDetailAssetDTO, ScanRewardDetailViewModel>().ReverseMap();

            CreateMap<ContainerAssetDTO, ContainerViewModel>().ReverseMap();

            CreateMap<ContainerRewardAssetDTO, ContainerRewardViewModel>().ReverseMap();

            CreateMap<CloneConfigDTO, CloneViewModel>().ReverseMap();

            CreateMap<GlobalDropsConfigDTO, GlobalDropsViewModel>().ReverseMap();

            CreateMap<HatchConfigDTO, HatchViewModel>().ReverseMap();

            CreateMap<CharacterDTO, PlayerViewModel>()
                .ForMember(x => x.MapId, src => src.MapFrom(y => y.Location.MapId)).ReverseMap();
        }
    }
}